...
from website.settings import ALLOWED_SIGNUP_DOMAINS
...
class CommercantForm(forms.ModelForm):
    class Meta:
        model = Commercant
        fields = ['status_professionel','lien_fb']

class ProduitForm(forms.ModelForm):
    class Meta:
        model = Produit
        fields = ['title', 'prix', 'categorie', 'descreption','tags','genre', 'type', 'etat','genrt', 'categorie','logo', 'image1' , 'image2', 'image3']
...
class MyModelForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['prix'].widget = forms.HiddenInput()
